...
def start(update, context):
    ...
    buttons.buildbutton("Repo", "https://t.me/tg_bot_support")
    buttons.buildbutton("Channel", "https://t.me/tg_bot_support")
...
help = Telegraph(access_token=telegraph_token).create_page(
        title='MT MIRROR HELP',
        author_name='😈 DEVIL 😈',
        author_url='https://t.me/amzmtaccount',
